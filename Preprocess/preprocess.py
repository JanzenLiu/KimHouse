...
X_train = train[hr.bld_feats + hr.caf_feats + hr.pop_feats + hr.ofc_feats + hr.rel_feats].copy()
...
X_test = test[hr.bld_feats + hr.caf_feats + hr.pop_feats + hr.ofc_feats + hr.rel_feats].copy()
